...
class TodoListAdapter(val context : Context, val arrayList : ArrayList<TodoModel>, val clickListener: RecyclerViewClickListener) : RecyclerView.Adapter<TodoListAdapter.TodoViewHolder>() {
    ...
    inner class TodoViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        val done: ImageView = view.findViewById(R.id.done)
        ...
        init{
            ...
            edit.setOnClickListener {
                clickListener.onEditButtonClick(adapterPosition)
            }
            ...
            delete.setOnClickListener {
                ...
                clickListener.onDoneButtonClick(adapterPosition)
            }
        }
